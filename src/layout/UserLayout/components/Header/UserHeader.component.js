...
import image from "assets/images/sakuraLogo.jfif";
...
function OrdersManagePage(props) {
  ...
  return (
    <div>
          ...
          <Container className={classes.containerPadding}>
            <Box className={classes.main_header}>
              ...
              <Box className={classes.buttons}>
                <Button
                  onClick={(e) => navigate(PATHS.LOGIN_PANEL_MANAGEMENT)}
                ...
                <Button
                  startIcon={
                    <Badge color="error" badgeContent={props.ordersLength}>
      ...
      <Container>
        <Box className={classes.margin_header}>{props.children}</Box>
      </Container>
      <ScrollTop {...props}>
