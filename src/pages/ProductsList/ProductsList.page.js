...
const ProductsList = () => {
  ...
  return (
    <>
      <Helmet>
        <title>فروشگاه ساکورا | لیست محصولات </title>
      </Helmet>
      <Box className={classes.orderBox}>
        <Box
          className={classes.sideBar}
          sx={{ display: menuIcon ? "flex" : "none" }}
        >
          <CloseOutlinedIcon
            color="error"
            onClick={(e) => setMenuIcon(!menuIcon)}
            className={`${classes.menuIcon} ${classes.sidebarIcon}`}
          />
          <Button
            style={{
              background:
                background === "گوشی موبایل" ? "#cdc7ff7a" : "transparent",
            }}
            className={classes.sidebarButton}
            onClick={(e) => handleCategory("گوشی موبایل")}
            sx={{ marginTop: "20px", justifyContent: "flex-start" }}
          >
            {" "}
            کالاهای گروه گوشی موبایل{" "}
          </Button>
          <Button
            style={{
              background: background === "لپتاپ" ? "#cdc7ff7a" : "transparent",
            }}
            className={classes.sidebarButton}
            onClick={(e) => handleCategory("لپتاپ")}
          ...
          <Button
            style={{
              background:
                background === "کامپیوتر همه کاره"
                  ? "#cdc7ff7a"
                  : "transparent",
            }}
            className={classes.sidebarButton}
            onClick={(e) => handleCategory("کامپیوتر همه کاره")}
            sx={{ justifyContent: "flex-start" }}
          >
            {" "}
            کالاهای گروه کامپیوتر همه کاره{" "}
          </Button>
          <Button
            style={{
              background:
                background === "هدفون بی سیم" ? "#cdc7ff7a" : "transparent",
            }}
            className={classes.sidebarButton}
            onClick={(e) => handleCategory("هدفون بی سیم")}
            sx={{ justifyContent: "flex-start" }}
          >
            {" "}
            کالاهای گروه هدفون{" "}
          ...
          <Typography
            sx={{ fontSize: ".9rem", marginTop: "8px", padding: "0 .6rem" }}
          >
            {" "}
            فیلتر بر اساس:{" "}
          </Typography>
