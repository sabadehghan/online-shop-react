...
const OrdersManage = (props) => {
  ...
  return (
    <>
      <Helmet>
        <title>فروشگاه ساکورا | مدیریت کالاها </title>
      </Helmet>
      <Box className={classes.box}>
        ...
        <Button
          onClick={(e) => handleModal(null, "add")}
            ...
            <Box className={classes.modalBox}>
                ...
                >
                  {!!imageArray.length &&
                    imageArray.map((image, index) => (
                      <figure
                        onClick={(e) => handleImageDelete(index)}
              ...
              >
                ...
                <FormControl fullWidth>
                  <InputLabel name="category" id="demo-simple-select-label">
                    دسته بندی
                  </InputLabel>
                  <Select
                    required={typeModal === "add"}
                    ...
                    <TableRow hover role="checkbox" tabIndex={-1} key={item.id}>
                      ...
                      <TableCell key={item.key}>
                        <Box sx={{ display: "flex", gap: "10px" }}>
                          <Button
                            onClick={(e) => handleModal(item.id, "edit")}
                            color="warning"
                            variant="contained"
                          >
                            {" "}
                          ...
                          <Button
                            onClick={(e) => handleOpenModalDelete(e, item.id)}
                            color="error"
                            variant="contained"
                          >
                            {" "}
