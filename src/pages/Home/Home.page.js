...
const HomePage = (props) => {
  ...
  return (
    <>
      <Button
        onClick={(e) => navigate("product-list/گوشی موبایل")}
      ...
      <Button
        onClick={(e) => navigate("product-list/لپتاپ")}
        endIcon={<ArrowLeftIcon sx={{ fontSize: "3rem!important" }} />}
        sx={{
          fontSize: "1.8rem",
          lineHeight: "4rem",
      ...
      <Button
        onClick={(e) => navigate("product-list/کامپیوتر همه کاره")}
        endIcon={<ArrowLeftIcon sx={{ fontSize: "3rem!important" }} />}
        sx={{
          fontSize: "1.8rem",
          lineHeight: "4rem",
      ...
      >
        {" "}
        آیتم های گروه کامپیوتر همه کاره{" "}
      </Button>
      <Box sx={{ flexGrow: 1 }}>
        <Grid
          container
      ...
      <Button
        onClick={(e) => navigate("product-list/هدفون بی سیم")}
        endIcon={<ArrowLeftIcon sx={{ fontSize: "3rem!important" }} />}
        sx={{
          fontSize: "1.8rem",
          lineHeight: "4rem",
